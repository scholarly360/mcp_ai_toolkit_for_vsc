"""
This Python script demonstrates how to integrate AI models with MCP (Model Context Protocol) tools to create 
an intelligent web exploration assistant. Here's what it does
 Uses 'azure-ai-inference' and connect to 'Playwright MCP Server'
We are using Azure OpenAI Models here (gpt-4o-mini)
Created using AI Toolkit Changed few things
...
class MCPClient:
    def __init__(self):
        ...
        self.azureai = ChatCompletionsClient(
            endpoint = "https://ai-yogendrasisodia7334ai963339814974.openai.azure.com/openai/deployments/gpt-4o-mini",
...
async def main():
    client = MCPClient()
    messages = [
        SystemMessage(content = "You are a web exploration assistant that can navigate to websites, take screenshots, and provide summaries of web content. You'll help users explore the web by visiting sites and extracting useful information."),
        UserMessage(content = [
